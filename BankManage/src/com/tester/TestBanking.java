...
import com.validation.BankingUtils;
import com.validation.BankingValidationRules;
			...
			while (!exit) {
				...
				try {
					...
					case 1:
						...
						BankAccount acct = BankingValidationRules.validateAllInputs(sc.nextInt(), sc.next(), sc.next(), sc.nextDouble(),
								sc.next(), accountMap);
